...
bool Serializer<bool>::Unmarshal(Napi::Env env, Napi::Value value) {
...
std::string Serializer<std::string>::Unmarshal(Napi::Env env,
                                               Napi::Value value) {
...
int8_t Serializer<int8_t>::Unmarshal(Napi::Env env, Napi::Value value) {
...
uint8_t Serializer<uint8_t>::Unmarshal(Napi::Env env, Napi::Value value) {
...
int16_t Serializer<int16_t>::Unmarshal(Napi::Env env, Napi::Value value) {
  return value.ToNumber().Int32Value();
}
...
uint16_t Serializer<uint16_t>::Unmarshal(Napi::Env env, Napi::Value value) {
  return value.ToNumber().Uint32Value();
}
...
int32_t Serializer<int32_t>::Unmarshal(Napi::Env env, Napi::Value value) {
  return value.ToNumber().Int32Value();
}
...
uint32_t Serializer<uint32_t>::Unmarshal(Napi::Env env, Napi::Value value) {
  return value.ToNumber().Uint32Value();
}
...
int64_t Serializer<int64_t>::Unmarshal(Napi::Env env, Napi::Value value) {
...
uint64_t Serializer<uint64_t>::Unmarshal(Napi::Env env, Napi::Value value) {
  return value.ToNumber().Uint32Value();  // No Uint64Value?
}
Napi::Value Serializer<uint64_t>::Marshal(Napi::Env env, uint64_t value) {
  return Napi::Value::From(env, value);
}
long long Serializer<long long>::Unmarshal(Napi::Env env, Napi::Value value) {
  return value.ToNumber().Int64Value();
}
...
float Serializer<float>::Unmarshal(Napi::Env env, Napi::Value value) {
...
double Serializer<double>::Unmarshal(Napi::Env env, Napi::Value value) {
